...
struct FusedMoEWeightSelector<FusedMoEDataType::kBlockScaleFp8,
    ...
    using Stage1Trait = BlockScaleFp8Stage1Schedule<Config>;
...
struct FusedMoEWeightSelector<FusedMoEDataType::kMxFp4,
    ...
    using W13 = typename W13Weights::W13;
    using W2 = typename W2Weights::W2;
    using Stage1Trait = PetitMxFp4Stage1Schedule<Config>;
...
template <FusedMoEStage1Buffering kBuffering, class Stage1Trait>
struct FusedMoEStage1OpSelector {
};

template <class Stage1Trait>
struct FusedMoEStage1OpSelector<FusedMoEStage1Buffering::kSingleBuffer,
                                Stage1Trait> {
    using Type = OnestageFusedMoEStage1SingleBufferOp<Stage1Trait>;
};

template <class Stage1Trait>
struct FusedMoEStage1OpSelector<FusedMoEStage1Buffering::kDoubleBuffer,
                                Stage1Trait> {
    using Type = OnestageFusedMoEStage1DoubleBufferOp<Stage1Trait>;
};
...
template <FusedMoESolutionId id> struct ConfigSelector {
    ...
    using Stage1Trait = typename Weight::Stage1Trait;
    using Stage1Op =
        typename FusedMoEStage1OpSelector<id.stage1_buffering,
                                          Stage1Trait>::Type;
    using Stage2Trait = typename Weight::Stage2Trait;
    using Stage2Op = OnestageFusedMoEStage2Op<Stage2Trait>;
    ...
    using QuantizeAndShuffleOp =
        QuantizeAndShuffleFp8<kNumWarps, kGroupN,
    ...
    static int Invoke(FusedMoE1StageParams params) {
        ...
        if (params.n == 0 || params.k == 0 || params.n % kQuantBlockK != 0 ||
            params.k % kQuantBlockK != 0) {
            return kFusedMoEErrorInvalidArgument;
        }
        ...
        if (params.act == nullptr || params.w13 == nullptr ||
            ...
            params.scales_act == nullptr || params.scales_w13 == nullptr ||
        ...
        if (params.num_persistent_tgs > 0) {
            unsigned persistent_route_groups =
                tal::CeilingDiv<unsigned>(params.num_persistent_tgs, split_k);
        ...
        OnestageFusedMoEBlockScaleFP8Compute<Kernel>
            <<<grids, blocks, 0, params.stream>>>(
                ...
                params.scales_w2, params.m, params.n, params.k,
                num_experts, persistent_route_step, params.w13_bias,
                params.w2_bias);
