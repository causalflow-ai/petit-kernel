#include "moe/rocm/fused_moe_blockscale_fp8_grid.cuh"

namespace causalflow::petit::rocm::moe {

int FusedMoEBlockScaleFP8(
    ...
    unsigned n, unsigned k, hipStream_t stream, unsigned num_persistent_tgs) {
