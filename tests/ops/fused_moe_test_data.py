...
# This deterministic case produces non-trivial stage-2 route outputs and catches
# W2 layout/advancement regressions without relying on captured serving data.
NUMERICALLY_SENSITIVE_ATOL = 2.05e-2
TOPK_IDS = (
...
def numerically_sensitive_topk(
    device: torch.device,
